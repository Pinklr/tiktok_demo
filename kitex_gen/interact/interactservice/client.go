...
type Client interface {
	...
	CountUserFavorite(ctx context.Context, Req *interact.CountUserFavoriteRequest, callOptions ...callopt.Option) (r *interact.CountUserFavoriteRequest, err error)
}
...
func (p *kInteractServiceClient) CountUserFavorite(ctx context.Context, Req *interact.CountUserFavoriteRequest, callOptions ...callopt.Option) (r *interact.CountUserFavoriteRequest, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
